...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('admin.admin-management.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="password" 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors pr-12 @error('password') border-red-500 ring-2 ring-red-200 @enderror" 
                                   id="password" 
                                   name="password" 
                        ...
                        @enderror
                        <p class="text-gray-500 text-xs">Minimal 8 karakter</p>
                    </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-start space-x-3 cursor-pointer p-4 border border-gray-200 rounded-lg hover:bg-white hover:border-blue-300 transition-all">
                            <input type="radio" 
                                   name="admin_type" 
                                   value="regular" 
                        ...
                        <label class="flex items-start space-x-3 cursor-pointer p-4 border border-gray-200 rounded-lg hover:bg-white hover:border-red-300 transition-all">
                            <input type="radio" 
                                   name="admin_type" 
                                   value="super" 
                    ...
                    <input type="hidden" name="is_super_admin" id="is_super_admin" value="0">
                </div>

                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                    <button type="submit" 
                            class="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 px-6 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-colors duration-300 shadow-md hover:shadow-lg font-medium flex items-center justify-center">
