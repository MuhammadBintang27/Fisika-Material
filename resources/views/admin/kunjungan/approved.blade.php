...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Kunjungan Disetujui</h1>
            <p class="text-gray-600">Kelola permintaan kunjungan laboratorium yang sudah disetujui</p>
        </div>
                            ...
                            @foreach($kunjungan as $visit)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800">{{ $visit->status_label }}</span>
                                    </td>
