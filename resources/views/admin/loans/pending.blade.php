...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Kelola permintaan peminjaman alat laboratorium yang masih menunggu persetujuan</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form method="GET" action="{{ route('admin.loans.pending') }}" class="flex items-center space-x-4">
            <div class="flex-1">
