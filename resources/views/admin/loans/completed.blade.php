...
<div class="space-y-8">
    <!-- Header -->
    <div class="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl p-8 text-white shadow-xl border border-indigo-500">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold mb-2">Peminjaman Selesai</h1>
                <p class="text-indigo-100 text-lg">Kelola peminjaman alat laboratorium yang sudah selesai</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <form method="GET" action="{{ route('admin.loans.completed') }}" class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100">
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-bold text-gray-900">Daftar Peminjaman Selesai</h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($loans as $loan)
                                <tr class="hover:bg-indigo-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-mono font-semibold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg border border-indigo-200">
                                            {{ $loan->tracking_code }}
                                        </div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-600 flex items-center justify-center">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada peminjaman selesai</h3>
                    <p class="mt-1 text-sm text-gray-500">Belum ada peminjaman alat yang telah selesai</p>
                </div>
            @endif
        </div>
    </div>
