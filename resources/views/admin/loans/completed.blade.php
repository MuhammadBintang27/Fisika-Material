...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Peminjaman Selesai</h1>
            <p class="text-gray-600">Kelola permintaan peminjaman alat laboratorium yang sudah selesai</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form method="GET" action="{{ route('admin.loans.completed') }}" class="flex items-center space-x-4">
            <div class="flex-1">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div class="flex items-center space-x-4">
            ...
            <a href="{{ route('admin.loans.completed') }}" 
               class="px-4 py-2 rounded-lg font-medium bg-gray-100 text-gray-700">
                Selesai
            </a>
                            ...
                            @foreach($loans as $loan)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-700">COMPLETED</span>
                                    </td>
