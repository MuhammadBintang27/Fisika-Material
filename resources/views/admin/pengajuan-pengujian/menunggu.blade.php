...
@section('title', 'Pengajuan Menunggu')

@section('content')
<div class="space-y-6">
    <!-- Header -->
    <div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl shadow-lg text-white p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">Pengajuan Menunggu</h1>
                <p class="text-amber-100">Kelola pengajuan pengujian yang menunggu persetujuan</p>
            </div>
            <div class="text-right">
                <div class="text-2xl font-bold">{{ $pengajuan->total() }}</div>
                <div class="text-amber-100">Total Pengajuan</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <form method="GET" action="{{ route('admin.pengajuan-pengujian.menunggu') }}" class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada pengajuan menunggu</h3>
                    <p class="text-gray-500">Belum ada pengajuan pengujian yang menunggu persetujuan</p>
                </div>
            @endif
        </div>
    </div>
