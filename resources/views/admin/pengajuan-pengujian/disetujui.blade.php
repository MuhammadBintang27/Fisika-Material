...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg text-white p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">Pengajuan Disetujui</h1>
                <p class="text-green-100">Kelola pengajuan pengujian yang telah disetujui</p>
            </div>
            <div class="text-right">
                <div class="text-2xl font-bold">{{ $pengajuan->total() }}</div>
                <div class="text-green-100">Total Pengajuan</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <form method="GET" action="{{ route('admin.pengajuan-pengujian.disetujui') }}" class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada pengajuan disetujui</h3>
                    <p class="text-gray-500">Belum ada pengajuan pengujian yang disetujui</p>
                </div>
            @endif
        </div>
    </div>
