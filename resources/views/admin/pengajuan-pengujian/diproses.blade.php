...
@section('title', 'Pengajuan Diproses')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg text-white p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">Pengajuan Diproses</h1>
                <p class="text-blue-100">Kelola pengajuan pengujian yang sedang diproses</p>
            </div>
            <div class="text-right">
                <div class="text-2xl font-bold">{{ $pengajuan->total() }}</div>
                <div class="text-blue-100">Total Pengajuan</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <form method="GET" action="{{ route('admin.pengajuan-pengujian.diproses') }}" class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
        <div class="flex items-center space-x-2 overflow-x-auto">
            ...
            <a href="{{ route('admin.pengajuan-pengujian.diproses') }}" 
               class="px-6 py-3 rounded-xl font-semibold transition-all duration-300 whitespace-nowrap bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada pengajuan diproses</h3>
                    <p class="text-gray-500">Belum ada pengajuan pengujian yang sedang diproses</p>
                </div>
            @endif
        </div>
    </div>
