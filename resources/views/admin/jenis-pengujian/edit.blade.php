...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Jenis Pengujian</h1>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
        <form action="{{ route('admin.jenis-pengujian.update', $jenisPengujian->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
