    ...
    <div class="relative z-20 mx-6 px-4 sm:px-6 lg:px-8 text-center max-w-6xl">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-amber-200">Layanan</span>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
        ...
        <div class="scroll-animate mb-8 opacity-0" data-animation="fade-up" data-delay="200">
            <h1 class="font-poppins text-4xl md:text-6xl font-bold leading-tight mb-6">
                ...
                <span class="bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text text-transparent drop-shadow-lg"> Pengujian</span>
            </h1>
            <p class="text-xl md:text-2xl text-amber-100 max-w-4xl mx-auto leading-relaxed">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        @if($layanan->count() > 0)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden group">
                    <!-- Header -->
                    <div class="bg-gradient-to-r from-[#968c82] to-[#635849] p-6 text-white">
                        ...
                        @else
                            <p class="text-amber-100 text-lg font-semibold">Gratis</p>
                        @endif
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3 mb-6">
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-clock w-4 h-4 mr-3 text-amber-600"></i>
                                <span>Estimasi selesai: {{ $item->estimasiSelesaiHari }} hari kerja</span>
                            </div>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-certificate w-4 h-4 mr-3 text-amber-600"></i>
                                <span>Hasil berstandar internasional</span>
                            </div>
                            <div class="flex items-center text-sm text-gray-500">
                                <i class="fas fa-download w-4 h-4 mr-3 text-amber-600"></i>
                        ...
                        <a href="{{ route('testing.detail', $item->id) }}" 
                           class="w-full bg-gradient-to-r from-[#968c82] to-[#635849] text-white py-3 px-6 rounded-xl font-semibold hover:from-[#635849] hover:to-[#443f35] transition-all duration-300 transform group-hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center">
            ...
            <!-- Info Section -->
            <div class="mt-16 bg-gradient-to-r from-[#968c82] to-[#635849] rounded-2xl p-8 text-white">
        ...
        @else
            ...
            <div class="text-center py-16">
                ...
                <a href="{{ route('home') }}" 
                   class="bg-amber-600 text-white px-6 py-3 rounded-xl hover:bg-amber-700 transition-colors font-semibold inline-flex items-center">
