    ...
    <div class="relative z-20 mx-6 px-4 sm:px-6 lg:px-8 text-center max-w-6xl">
        ...
        <div class="scroll-animate mb-8 opacity-0" data-animation="fade-up" data-delay="200">
            ...
            <p class="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
                Lacak status peminjaman alat Anda
            </p>
        </div>
    </div>
</section>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <p><span class="font-medium">Mulai:</span> {{ $loan->tanggal_pinjam->format('d/m/Y H:i') }}</p>
                                        <p><span class="font-medium">Selesai:</span> {{ $loan->tanggal_pengembalian->format('d/m/Y H:i') }}</p>
                                    </div>
                                </div>
                            </div>
